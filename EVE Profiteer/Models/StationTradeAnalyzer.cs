...
namespace eZet.EveProfiteer.Models {
    public class StationTradeAnalyzer {

        public ICollection<StationTradeEntry> Result { get; set; }
        ...
        public StationTradeAnalyzer(IEnumerable<Item> itemData, IEnumerable<ItemPrices.ItemPriceEntry> sellOrders, IEnumerable<ItemPrices.ItemPriceEntry> buyOrders, IEnumerable<ItemHistory.ItemHistoryEntry> history) {
            ...
            Result = new List<StationTradeEntry>();
        }
        ...
        public void Analyze() {
            foreach (var item in itemData) {
                ...
                Result.Add(new StationTradeEntry(item, sellOrder, buyOrder, itemHistory));
            }
        }
