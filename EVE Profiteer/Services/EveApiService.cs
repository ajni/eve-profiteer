...
namespace eZet.EveProfiteer.Services {
    ...
    public class EveApiService {
        ...
        public IEnumerable<Transaction> GetNewTransactions(Models.ApiKey key, ApiKeyEntity entity, long latestId) {
            return getTransactions(key, entity, 1000, latestId);
        }

        public IEnumerable<Transaction> GetAllTransactions(Models.ApiKey key, ApiKeyEntity entity,
            Func<Transaction> transactionFactory) {
            return getTransactions(key, entity, 5000);
        }

        public IList<JournalEntry> GetNewJournalEntries(Models.ApiKey key, ApiKeyEntity entity, long latestId) {
        ...
        private static IList<JournalEntry> getJournalEntries(Models.ApiKey key, ApiKeyEntity entity, int rowLimit, long latestId = 0) {
        ...
        private static IEnumerable<Transaction> getTransactions(Models.ApiKey key, ApiKeyEntity entity, int rowLimit, long limitId = 0) {
